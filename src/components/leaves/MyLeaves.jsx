...
export default function MyLeaves() {
  ...
  const handleStartDateChange = (date) => {
    ...
    setFieldError("noOfDays", validateField("noOfDays", newForm.noOfDays, newForm, date, null));
    if (submitError && setSubmitError) setSubmitError(null);
  };
  ...
  const handleEndDateChange = (date) => {
    ...
    setFieldError("noOfDays", validateField("noOfDays", newForm.noOfDays, newForm, startDate, date));
    if (submitError && setSubmitError) setSubmitError(null);
  };
